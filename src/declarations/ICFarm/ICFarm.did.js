export const idlFactory = ({ IDL }) => {
  ...
  const R_10 = IDL.Variant({ 'ok' : IDL.Nat, 'err' : IDL.Text });
  ...
  const R_1 = IDL.Variant({ 'ok' : Inventory, 'err' : IDL.Text });
  const R_9 = IDL.Variant({
    'ok' : IDL.Vec(IDL.Tuple(IDL.Nat, Crop)),
    'err' : IDL.Text,
  });
  const R_8 = IDL.Variant({ 'ok' : IDL.Vec(IDL.Principal), 'err' : IDL.Text });
  ...
  const R_3 = IDL.Variant({ 'ok' : Player, 'err' : IDL.Text });
  const Time = IDL.Int;
  ...
  return IDL.Service({
    'addCrop' : IDL.Func([Crop], [R_10], []),
    'addGameMasters' : IDL.Func([IDL.Vec(IDL.Principal)], [R], []),
    'buy' : IDL.Func(
        [IDL.Vec(IDL.Tuple(IDL.Nat, IDL.Nat, IDL.Nat)), IDL.Nat],
        [R_1],
        [],
      ),
    'claimOwner' : IDL.Func([], [R], []),
    'getCrops' : IDL.Func([], [R_9], ['query']),
    'getGameMasters' : IDL.Func([], [R_8], ['query']),
    'getPrices' : IDL.Func([], [R_7], ['query']),
    'harvest' : IDL.Func([IDL.Vec(IDL.Nat)], [R_6], []),
    'initPlayer' : IDL.Func([IDL.Text, IDL.Text], [R_5], []),
    'inventory' : IDL.Func([], [R_1], ['query']),
    'plant' : IDL.Func([IDL.Vec(IDL.Tuple(IDL.Nat, IDL.Nat))], [R_4], []),
    'queryPlayer' : IDL.Func([IDL.Principal], [R_3], ['query']),
    'queryPlots' : IDL.Func([IDL.Vec(IDL.Nat)], [R_2], ['query']),
    'removeGameMasters' : IDL.Func([IDL.Vec(IDL.Principal)], [R], []),
    ...
    'transferOwner' : IDL.Func([IDL.Principal], [R], []),
